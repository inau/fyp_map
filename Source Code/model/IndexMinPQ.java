 ...
 *  Algorithms 4 - Robert Sedgewick & Kevin Wayne
 *********************************************************************/
...
/**
 * This class is borrowed from the above comment. 
 * Its a priority queue with an index system.
 * @author Stahl
 *
 * @param <Key> Whatever comparable key needs to be put in the queue.
 */
public class IndexMinPQ<Key extends Comparable<Key>> implements Iterable<Integer> {
    ...
    public IndexMinPQ(int NMAX) {
    	if(NMAX < 0)	throw new IllegalArgumentException("parameter NMAX was negative");
    ...
    public boolean contains(int k) {
    	if(k < 0)	throw new IllegalArgumentException("parameter k was negative");
